...
int main(int argc, char const *argv[])
{
  ...
  std::string resName = "residue_"+run+"_"+detName+"_residue"+".root";
  std::cout<<"residue file: "<<resName<<std::endl;
